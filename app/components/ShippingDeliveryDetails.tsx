...
function SectionBody({ section }: { section: ShippingSection }) {
...
export default function ShippingDeliveryDetails() {
  const { quickNavigation, sections } = useMessages().shippingDelivery;
