...
function KitCard({
  ...
  return (
    <article
      className={`group relative mb-4 flex flex-col overflow-hidden rounded-2xl bg-warm-white sm:mb-6 sm:rounded-3xl lg:flex-row lg:items-center ${cardHover} hover:shadow-dark-green/10`}
    >
      <Link
        href={`/${product.slug}`}
